CXXFLAGS:=-g -std=c++11 -Wall -Wextra -Isrc -lrt -Wl,--no-as-needed,-E -ldl 
...
obj:=bin/Attribute.o bin/Table.o bin/Parser.o bin/Query.o bin/Schema.o bin/TPCC_Schema.o bin/Types.o bin/Operator.o
