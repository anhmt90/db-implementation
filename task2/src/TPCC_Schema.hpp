...
template<> struct hash<tuple<Integer, Integer>>{
...
template<> struct hash<tuple<Integer, Integer, Integer>>{
...
template<> struct hash<tuple<Integer, Integer, Integer, Integer>>{
